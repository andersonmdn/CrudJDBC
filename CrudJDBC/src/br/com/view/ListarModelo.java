...
public class ListarModelo extends javax.swing.JFrame {
    ...
    private void txPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txPesquisaActionPerformed
        ModeloController mc = new ModeloController();
        List<Modelo> lista = new ArrayList<Modelo>();
        lista = mc.buscarModeloByNome(txPesquisa.getText());
        modelo.limpar();
        modelo = new ModeloTableModel(lista);
        tbMarca.setModel(modelo);
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        InserirModeloGUI im = new InserirModeloGUI(modelo);
        im.setVisible(true);
    ...
    private void btAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAtualizarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            AtualizarModeloGUI at = new AtualizarModeloGUI(selecionado, idModelo, modelo);
            at.setVisible(true);
        } else {
