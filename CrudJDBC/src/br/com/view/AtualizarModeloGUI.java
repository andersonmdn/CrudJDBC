...
public class AtualizarModeloGUI extends javax.swing.JFrame {
     ...
     */
    public AtualizarModeloGUI(int linhaSelecionada,int idModelo, ModeloTableModel modelo) {
        initComponents();
        this.linhaSelecionada = linhaSelecionada;
        this.modelo = modelo;
        Modelo m = new Modelo();
        ModeloController mc = new ModeloController();
        m = mc.buscarModeloById(idModelo);
        txId.setText(Integer.toString(m.getId()));
        txNome.setText(m.getDescrição());
    }
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        ModeloController mc = new ModeloController();
        mc.atualizar(m);
        modelo.updateModelo(linhaSelecionada, m);
        dispose();
